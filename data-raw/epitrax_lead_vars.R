...
epitrax_lead_vars <- list()

## Variable names in the export file ####

epitrax_lead_vars[["export"]] <- c(
...
## Variable order for data processing ####

epitrax_lead_vars[["ordered"]] <- c(
  # Record IDs
...
usethis::use_data(epitrax_lead_vars, overwrite = T)
